...
import com.testautomationu.utils.Highlighter;

public class GroupsDependsOnGroupsFAILTest
{
	WebDriver driver;
	...
	{
		System.setProperty("webdriver.chrome.driver", "/Users/jimgray/IdeaProjects/TAU-testng-intellij/src/test/resources/drivers/chromedriver");
	...
	{		
        ...
        Assert.fail("Could Not Open OrangeHRM");
